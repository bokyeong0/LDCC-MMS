...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var rowColor = ts.p.rowClickColor;
		
		var rowHight = ts.p.rowHight;
		var eg = $("<div "+ getstyle(stylemodule, 'entrieBox', false, 'ui-jqgrid '+rowColor+'-mod row-height-'+rowHight) +"></div>");
		...
		addRowNum = function (pos, irow, pG, rN, uiclass ) {
			...
			if(ts.p.rownumbersdesc){
				var totalrecords = ts.p.records;
				var rowNumber = totalrecords - (v-1);
				v = rowNumber;
			}
