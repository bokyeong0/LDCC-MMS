 ...
 */
	...
	$.jstree.core.prototype = {
		...
		get_original : function (obj, as_dom) {
			if(obj && obj.id) {
				obj = obj.id;
			}
			var dom;
			try {
				if(this._model.data[obj]) {
					obj = this._model.data[obj].original;
				}
				else if(typeof obj === "string" && this._model.data[obj.replace(/^#/, '')]) {
					obj = this._model.data[obj.replace(/^#/, '')];
				}
		...
		get_children_dom : function (obj) {
			obj = this.get_node(obj, true);
			if(obj[0] === this.element[0]) {
				var children =  this.get_container_ul().children(".jstree-node");
				return children;
			}
			if(!obj || !obj.length) {
				return false;
			}
			var childNode = obj.children(".jstree-children").children(".jstree-node");
		...
		get_coreData : function (full) {
			return full ? $.map(this._data.core.selected, $.proxy(function (i) { return this.get_node(i).original; }, this)) : this._data.core.selected.slice();
		},
		/**
 ...
 */
	...
	$.jstree.plugins.checkbox = function (options, parent) {
			...
			if(!this.settings.checkbox.tie_selection) {
				this.element
					.on('model.jstree', $.proxy(function (e, data) {
						this._data.checkbox.coreData = data.instance.settings.core.data;
						var m = this._model.data,
							p = m[data.parent],
							dpc = data.nodes,
							i, j;
		 ...
		 * @plugin checkbox
		 */
		this.get_chkData = function (full) {
			return this.get_coreData(full); 
		};
		/**
