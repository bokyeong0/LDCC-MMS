	...
	<div class="search-form clearfix" >
           <form class="form-inline" >
			...
			<div class="search-button-group">
				...
				<button type="button" id="languageAddRowBtn" class="btn btn-sm btn-info">
				<i class="fa fa-plus"></i> 행추가
				</button>
				<button type="button" id="languageDelRowBtn" class="btn btn-sm btn-danger">
				<i class="fa fa-minus"></i> 행삭제
				</button>
<!-- 				<button type="button" id="programModGridBtn" data-btn-mod="nomal" class="btn btn-sm btn-success"> -->
<!-- 				<i class="fa fa-edit "></i> 수정 -->
<!-- 				</button> -->
				<button type="button" id="languageSaveRowBtn"  class="btn btn-sm btn-success">
...
<div class="grid-wrapper" >
	<table id="systemLanguageGrid"  ></table>
	<div id="systemLanguageGridNavi"></div>
</div>
<script src="/js/views/settings/system/system_language.js"></script>
</body>
</html>